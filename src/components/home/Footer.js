...
import haui from '../../assets/image/haui.jpg'
...
const Footer=()=>{
    return (
        <div className="text-center mt-10">
           <p><span className="underline hover:cursor-pointer"><a href='http://localhost:3000/'>Topcoder</a></span> Copyright 2003-2023 Vu Nguyen Tien</p>
           <p>The Web 1.0 platform</p>
           <h4>Supported by</h4>
           <div className='text-center'>
              <a href='https://openai.com/'><img src={openai} className='w-40 inline-flex'/></a>
              <a href='https://www.haui.edu.vn/vn'><img src={haui} className='w-20 inline-flex'/></a>
